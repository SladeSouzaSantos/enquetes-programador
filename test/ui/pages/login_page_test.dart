...
import 'package:enquetes_programadores/ui/pages/pages.dart';
...
void main(){
  ...
  testWidgets("Should load with correct initial state", (WidgetTester tester) async{
    ...
    expect(
        ...
        reason: "when a TextFormField has only one text child, means it has no errors, "
            "since one of the childs is always the hint/label text"
    );
  ...
  testWidgets("Should desable buttom if form is invalid", (WidgetTester tester) async{
